"""Mock RAG function. Kuba replaces this with real retrieval."""
...
def mock_rag(query: str, category: str) -> list[Evidence]:
    """Return hardcoded evidence for the golden scenario. Replace with real RAG."""
    q = query.lower()
    ...
    if "feature" in q and ("ready" in q or "finished" in q or "done" in q or "implemented" in q):
        return [
            ...
            Evidence(
                source="Slack",
                snippet="Lead engineer posted yesterday: 'Feature X has deployment issues, not production-ready yet.'",
    ...
    if ("revenue" in q or "cost" in q or "million" in q or "infra" in q or "cut" in q):
        return [
            Evidence(
                ...
                snippet="Poland team XYZ service: 2024 revenue $1M, infra costs $3.4M. 2025 revenue $3M, infra costs $3.5M.",
